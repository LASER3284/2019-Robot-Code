...
CCANPosition::CCANPosition(int nDeviceID)
{
	...
	m_dFwdMoveSpeed					= dDefualtCANPositionManualFwdSpeed;
	m_dRevMoveSpeed					= dDefualtCANPositionManualRevSpeed;
...
/******************************************************************************
	...
	Returns: 		Nothing
******************************************************************************/
void CCANPosition::SetManualSpeed(double dForward, double dReverse)
{
